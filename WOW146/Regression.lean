...
The hypotheses of `WOW146.exceptional_case` are nonvacuous. This module adapts
...
theorem reg_exceptional : 6 ≤ regGraph.largestInducedTreeSize :=
  WOW146.exceptional_case regGraph reg_connected reg_radius reg_diam reg_eccSet

#print axioms WOW146.Regression.reg_exceptional

end WOW146.Regression
